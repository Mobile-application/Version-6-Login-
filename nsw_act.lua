...
local function hyperLink()
  system.openURL("https://www.legislation.nsw.gov.au/acts/2007-64.pdf")
end
...
function scene:create( event )
	...
	OVERVIEW OF THE ACT:
	Part 1, section 4 of the Act outlines the definitions of listening devices and surveillance
	devices.
	
	Part 2, section 7 of the Act outlines the regulation of installation, use and maintenance of
